define([
    ...
    var prototype = {
        get direction() {
            return vec2.fromValues(
                Context.cos(this.displacement),
                Context.sin(this.displacement)
            );
        },
        get intesity() {
            var
            ...
            endingColorHue = 10;
            return {
                hue: Context.abs((((100 / this.capacity) * this.power) * (startingColorHue - endingColorHue) / 100).toFixed() - startingColorHue),
                opacity: 0.4
            };
        },
    ...
    return {
        create: function create(configuration) {
            ...
            engine.radiansPerSecond = configuration.radiansPerSecond || Context.PI / 2;
            // internal properties
            engine.power = 0;
            return engine;
        }
