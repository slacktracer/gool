    ...
    Engine = {
        ...
        prototype: {
            ...
            draw: function draw(context, position, radius) {
                ...
                context.moveTo(radiusPlusHalfRadius * math.cos(math.TWO_PI * 0.25), radiusPlusHalfRadius * math.sin(math.TWO_PI * 0.25));
                context.arc(
                    0,
                    0,
                    radiusPlusHalfRadius,
                ...
                context.lineTo(doubleRadius * math.cos(math.TWO_PI * 0.5), doubleRadius * math.sin(math.TWO_PI * 0.5));
                context.closePath();
                context.lineWidth = 2;
