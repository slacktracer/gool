export const Grid = {
  create: function (prototype, squareSize, opacity, size) {
    var grid;
    ...
    switch (prototype) {
      case "infinite":
        grid = Object.create(this.infiniteGridPrototype);
        break;
      case "fixed size":
        grid = Object.create(this.fixedSizeGridPrototype);
        grid.width = size.width;
        grid.height = size.height;
        break;
      default:
        // 'start screen only'
        grid = Object.create(this.startScreenOnlyGridPrototype);
        break;
    }
  ...
  fixedSizeGridPrototype: {
    draw: function (context, metre) {
      var squareSizeInPixels,
        width,
        height,
        lineWidth,
        whereToStart,
  ...
  infiniteGridPrototype: {
    draw: function (context, metre, zoom, position) {
      var squareSizeInPixels,
        relativeWidth,
        relativeHeight,
      ...
      whereToStart =
        positionMinusRelativeWidth -
        (positionMinusRelativeWidth % squareSizeInPixels);
      ...
      whereToStart =
        positionMinusRelativeHeight -
        (positionMinusRelativeHeight % squareSizeInPixels);
  ...
  startScreenOnlyGridPrototype: {
    draw: function (context, metre, zoom) {
      var squareSizeInPixels,
        relativeWidth,
        relativeHeight,
        lineWidth,
