...
export const Token = {
  create: function create(configuration) {
    ...
    token.engine = configuration.engine
      ? Engine.create(configuration.engine)
      : Engine.create();
    ...
    token.body = Matter.Bodies.circle(
      token.position[0],
      token.position[1],
      token.radius * 40,
      {
  ...
  prototype: {
      ...
      return this.velocityDirection
        .mult(
          ...
          this.dragCoefficient *
            this.area *
            this.body.state.vel.clone().normSq(),
        )
        .negate();
    },
    ...
    draw: function draw(context, metre) {
      ...
      context.arc(0, 0, this.radius * metre, 0, math.TWO_PI, true);
      ...
      if (this.___cat) {
        ...
        context.drawImage(
          ...
          this.___cat.width,
          this.___cat.height,
          -this.___cat.width / 2 - 2,
          -this.___cat.height / 2 - 2,
          this.___cat.width + 4,
          this.___cat.height + 4,
        );
      }
      context.restore();
      context.save();
      ...
      context.translate(this.body.state.pos.x, this.body.state.pos.y);
      context.rotate(this.body.state.angular.pos);
      context.arc(0, 0, this.radius * metre - 3, 0, math.TWO_PI, true);
      context.lineWidth = 6;
